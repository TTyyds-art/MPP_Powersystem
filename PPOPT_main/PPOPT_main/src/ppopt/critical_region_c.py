...
class CriticalRegion:
    ...
    """
    def __init__(self, program:  MPQCQP_Program, set_list: List[List[int]], inactive_list: List[List[int]]):
        self.program = program
        self.active_set = set_list
        self.inactive_set= inactive_list
    ...
    def is_inside(self, theta: numpy.ndarray) -> numpy.ndarray:
        ...
        self.program.check_optimality(active_set=self.active_set, theta=theta)
